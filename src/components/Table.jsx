          ...
          <tbody>
            {cryptoData.map((data, index) => {
              return (
                <tr
                  key={data.id}
                  className="text-center text-base text-white capitalize  border-b borde-gray-100 hover:bg-gray-200 last:border-b-0 "
                >
                  <td className="py-4 flex items-center uppercase">
                    <button className="outline-0 border-0  bg-none cursor-pointer">
                      <svg
                        className="w-[1.5rem] ml-1.5 fill-current text-gray-100 hover:text-cyan fill-gray-100 hover:fill-cyan"
                        width="30"
                        height="30"
                        viewBox="0 0 30 30"
